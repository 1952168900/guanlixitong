...
public class UpdatePerView {
    ...
    public void init(){
        ...
        PAS.setBounds(10,60,160,25);
        PAStext.setBounds(200,60,165,25);
        CNAME.setBounds(10,100,160,25);
        CNAMEtext.setBounds(200,100,165,25);
        CINF.setBounds(10,140,160,25);
        CINFtext.setBounds(200,140,165,25);
        ...
        ActionListener updateListener=e -> {
            try {
            		new CusDao().updatePer(CIDtext.getText(),PAStext.getText(),CNAMEtext.getText(),CINFtext.getText());
                    jFrame.dispose();
